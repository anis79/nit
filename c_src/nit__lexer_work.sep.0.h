...
#define COLOR_nit__lexer_work__Token___cached_text 9
...
#define COLOR_nit__lexer_work__ALexerError___string 11
void nit__lexer_work___AError___init_error(val* self, val* p0, val* p1);
#define COLOR_nit__lexer_work__AParserError___token 11
...
#define COLOR_nit__location__SourceFile___string 2
...
#define COLOR_nit___nit__Lexer___standard__kernel__Object__init 28
