...
unsigned char* standard__ropes___standard__ropes__Concat___standard__string__Text__to_cstring(val* self) {
...
var15 = (unsigned char*)nit_alloc(var9);
var13 = var15;
goto RET_LABEL14;
RET_LABEL14:(void)0;
}
...
unsigned char* standard___standard__RopeBuffer___ns(val* self) {
unsigned char* var /* : NativeString */;
...
/* method ropes#RopeBuffer#ns= for (self: RopeBuffer, NativeString) */
void standard___standard__RopeBuffer___ns_61d(val* self, unsigned char* p0) {
...
var9 = (unsigned char*)nit_alloc(var6);
var7 = var9;
goto RET_LABEL8;
RET_LABEL8:(void)0;
}
...
var6 = (unsigned char*)nit_alloc(var3);
var4 = var6;
goto RET_LABEL5;
RET_LABEL5:(void)0;
}
...
unsigned char* var_nns /* var nns: NativeString */;
...
unsigned char* var_nns102 /* var nns: NativeString */;
...
var_rem = var77;
var84 = (unsigned char*)0/*special!*/;
{
{ /* Inline string#NativeString#new (var84,var_rem) on <var84:NativeString> */
var87 = (unsigned char*)nit_alloc(var_rem);
var85 = var87;
goto RET_LABEL86;
RET_LABEL86:(void)0;
}
...
var98 = (unsigned char*)0/*special!*/;
{
{ /* Inline string#NativeString#new (var98,var_count) on <var98:NativeString> */
var101 = (unsigned char*)nit_alloc(var_count);
var99 = var101;
goto RET_LABEL100;
RET_LABEL100:(void)0;
}
...
unsigned char* var_sits /* var sits: NativeString */;
...
var_bs = var36;
var43 = (unsigned char*)0/*special!*/;
{
{ /* Inline string#NativeString#new (var43,var_bs) on <var43:NativeString> */
var46 = (unsigned char*)nit_alloc(var_bs);
var44 = var46;
goto RET_LABEL45;
RET_LABEL45:(void)0;
}
...
unsigned char* var29 /* : NativeString */;
unsigned char* var31 /* : NativeString */;
unsigned char* var_mits /* var mits: NativeString */;
long var32 /* : Int */;
long var34 /* : Int */;
...
var51 = (unsigned char*)nit_alloc(var42);
var49 = var51;
goto RET_LABEL50;
RET_LABEL50:(void)0;
}
...
unsigned char* standard___standard__RopeBufferIter___ns(val* self) {
unsigned char* var /* : NativeString */;
unsigned char* var1 /* : NativeString */;
...
/* method ropes#RopeBufferIter#ns= for (self: RopeBufferIter, NativeString) */
void standard___standard__RopeBufferIter___ns_61d(val* self, unsigned char* p0) {
