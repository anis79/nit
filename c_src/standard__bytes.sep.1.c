...
unsigned char* standard___standard__Bytes___items(val* self) {
...
/* method bytes#Bytes#items= for (self: Bytes, NativeString) */
void standard___standard__Bytes___items_61d(val* self, unsigned char* p0) {
...
var3 = (unsigned char*)nit_alloc(0l);
var1 = var3;
goto RET_LABEL2;
RET_LABEL2:(void)0;
}
...
var_ns = var1;
{
((void(*)(val* self, unsigned char* p0))(self->class->vft[COLOR_standard__bytes__Bytes__items_61d]))(self, var_ns); /* items= on <self:Bytes>*/
}
{
...
var3 = (unsigned char*)nit_alloc(var_cap);
var1 = var3;
goto RET_LABEL2;
RET_LABEL2:(void)0;
}
...
var6 = (unsigned char*)nit_alloc(var1);
var4 = var6;
goto RET_LABEL5;
RET_LABEL5:(void)0;
}
...
void standard___standard__Bytes___append_ns(val* self, unsigned char* p0, long p1) {
unsigned char* var_ns /* var ns: NativeString */;
...
void standard___standard__Bytes___append_ns_from(val* self, unsigned char* p0, long p1, long p2) {
unsigned char* var_ns /* var ns: NativeString */;
long var_ln /* var ln: Int */;
...
var42 = (unsigned char*)nit_alloc(var37);
var40 = var42;
goto RET_LABEL41;
RET_LABEL41:(void)0;
}
...
unsigned char* standard__bytes___standard__bytes__BytesIterator___tgt(val* self) {
unsigned char* var /* : NativeString */;
unsigned char* var1 /* : NativeString */;
...
/* method bytes#BytesIterator#tgt= for (self: BytesIterator, NativeString) */
void standard__bytes___standard__bytes__BytesIterator___tgt_61d(val* self, unsigned char* p0) {
...
{
((void(*)(val* self, unsigned char* p0))(self->class->vft[COLOR_standard__bytes__BytesIterator__tgt_61d]))(self, var); /* tgt= on <self:BytesIterator>*/
}
{
