...
#define COLOR_nit__literal__LiteralVisitor__toolcontext_61d 19
#define COLOR_standard__kernel__Object__init 0
void nit___nit__Visitor___enter_visit(val* self, val* p0);
#define COLOR_nit__literal__LiteralVisitor___toolcontext 1
extern const char FILE_nit__literal[];
#define COLOR_nit__literal__ANode__accept_literal 22
#define COLOR_nit__parser_nodes__ANode__visit_all 20
#define COLOR_nit__literal___nit__literal__LiteralVisitor___standard__kernel__Object__init 21
...
#define COLOR_nit__literal__AFloatExpr___value 11
