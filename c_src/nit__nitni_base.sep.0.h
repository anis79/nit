...
extern const char FILE_nit__nitni_base[];
...
#define COLOR_nit__nitni_base___MClassType___MType__cname_blind 68
...
#define COLOR_nit__nitni_base___MGenericType___MType__mangled_cname 72
