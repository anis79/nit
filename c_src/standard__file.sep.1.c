...
{
var2 = ((unsigned char*(*)(val* self))(var_path->class->vft[COLOR_standard__string__Text__to_cstring]))(var_path); /* to_cstring on <var_path:String>*/
}
{
...
var_i = var19;
{
var20 = ((unsigned char*(*)(val* self))(var_i->class->vft[COLOR_standard__string__Text__to_cstring]))(var_i); /* to_cstring on <var_i:FlatText>*/
}
{
...
void standard___standard__FileWriter___write_native(val* self, unsigned char* p0, long p1) {
unsigned char* var_native /* var native: NativeString */;
...
var = NEW_standard__file__NativeFile(&type_standard__file__NativeFile);
{
var1 = ((unsigned char*(*)(val* self))(var_path->class->vft[COLOR_standard__string__Text__to_cstring]))(var_path); /* to_cstring on <var_path:String>*/
}
{
...
{
var1 = ((unsigned char*(*)(val* self))(self->class->vft[COLOR_standard__string__Text__to_cstring]))(self); /* to_cstring on <self:String>*/
}
{
...
unsigned char* var_cs /* var cs: NativeString */;
val* var5 /* : FlatString */;
...
{
var16 = ((unsigned char*(*)(val* self))(var15->class->vft[COLOR_standard__string__Text__to_cstring]))(var15); /* to_cstring on <var15:String>*/
}
{
...
short int standard__file___NativeString___file_exists(unsigned char* self) {
short int var /* : Bool */;
...
short int standard__file___NativeString___file_mkdir(unsigned char* self) {
short int var /* : Bool */;
short int var1 /* : Bool for extern */;
...
unsigned char* standard__file___NativeString___file_realpath(unsigned char* self) {
...
long standard__file___standard__file__NativeFile___io_read(val* self, unsigned char* p0, long p1) {
long var /* : Int */;
...
long standard__file___standard__file__NativeFile___io_write(val* self, unsigned char* p0, long p1) {
long var /* : Int */;
long var1 /* : Int for extern */;
void* var2 /* : NativeFile for extern */;
var2 = ((struct instance_standard__Pointer*)self)->value; /* unboxing NativeFile */
...
val* standard__file___standard__file__NativeFile___io_open_read(val* self, unsigned char* p0) {
val* var /* : NativeFile */;
...
val* standard__file___standard__file__NativeFile___io_open_write(val* self, unsigned char* p0) {
val* var /* : NativeFile */;
void* var1 /* : NativeFile for extern */;
val* var2 /* : NativeFile */;
...
unsigned char* standard__file___Sys___file_getcwd(val* self) {
unsigned char* var /* : NativeString */;
void* var1 /* : NativeString for extern */;
