...
#define COLOR_nit__modelize_class__AClasskind__mkind 40
...
#define COLOR_nit__modelize_class__AClassdef___mclass 6
...
#define COLOR_nit__modelize_class__AFormaldef___bound 5
