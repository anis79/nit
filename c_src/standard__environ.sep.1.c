...
unsigned char* var_res /* var res: NativeString */;
static unsigned char* varonce;
...
unsigned char* var_nulstr /* var nulstr: NativeString */;
...
{
var10 = ((unsigned char*(*)(val* self))(var7->class->vft[COLOR_standard__string__Text__to_cstring]))(var7); /* to_cstring on <var7:String>*/
}
{
...
unsigned char* standard__environ___NativeString___get_environ(unsigned char* self) {
